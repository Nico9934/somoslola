                ...
                <div>
                    ...
                    {product.variants && product.variants.length > 0 && (() => {
                        if (selectedVariant) {
                            ...
                            const hasPromo = selectedVariant.promotionPrice;
                            return (
                                <div className="mb-6">
                                    {hasPromo ? (
                                    ...
                                    {hasPromotion ? (
                                        <div className="space-y-1">
                                            <p className="text-2xl text-gray-400 line-through">
                                                ...
                                                {maxSalePrice !== minSalePrice && ` - $${maxSalePrice.toLocaleString()}`}
                                            </p>
                                            <div className="flex items-center gap-2">
                                                <p className="text-4xl font-bold text-red-600">
                                                    ${minPromoPrice.toLocaleString()}
                                                    {maxPromoPrice !== minPromoPrice && ` - $${maxPromoPrice.toLocaleString()}`}
                                                </p>
                                                <span className="text-sm font-semibold bg-red-100 text-red-600 px-2 py-1 rounded">
                                                    PROMO
                                                </span>
                                                            ...
                                                            {hasPromotion ? (
                                                                <>
                                                                    ...
                                                                    <p className="text-lg font-bold text-red-600">
                                                                        ${variant.promotionPrice.toLocaleString()}
                                                                    </p>
                                                                    <p className="text-xs text-green-600">
                                                                        6x ${(variant.promotionPrice / 6).toLocaleString(undefined, { maximumFractionDigits: 0 })}
                                                                    </p>
                                                                </>
                                                            ) : (
                                                                <>
                                                                    ...
                                                                    <p className="text-xs text-green-600">
                                                                        6x ${(variant.salePrice / 6).toLocaleString(undefined, { maximumFractionDigits: 0 })}
                                                                    </p>
                                                                </>
                                                            )}
                                                        </div>
